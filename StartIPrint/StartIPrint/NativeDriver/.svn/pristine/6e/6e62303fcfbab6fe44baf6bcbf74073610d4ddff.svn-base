...
EPOSTPDriver::EPOSTPDriver():Driver()
{

}

EPOSTPDriver::~EPOSTPDriver()
{

}

int EPOSTPDriver::InnerRemixBmp(byte* pBmpData, int bytePerLine, int bmpWidth, int bmpHeight, long lx, long ly, byte* pPrintData, int PrintDataLength, int xDPI, int yDPI)
{
...
void EPOSTPDriver::twentyfourPointPerCol(byte** DataBlock, byte* OutputData, float skipRowBlankLineFactor)
{
    long iDataCols = 0;
    long iBlankCols = 0;
    long wt = 0;
    ...
    OutputData[myxPos + 6] = 0x18;
    OutputData[myxPos + 7] = 0x00;
    myxPos += 8;
